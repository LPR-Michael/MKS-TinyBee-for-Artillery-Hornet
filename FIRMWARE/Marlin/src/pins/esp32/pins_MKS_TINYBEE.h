...
// Power control Unit
//
#define PS_ON_PIN                            141 // Origin for E1_STEP_PIN OR Z2_STEP_PIN
#define KILL_PIN                             142 // Origin for E1_DIR_PIN OR Z2_DIR_PIN
...
#define HEATER_0_PIN                         145
  ...
  #define FAN_PIN                            147  //BLACK    //红-侧边吹风(PC8)
  #define FAN1_PIN                           148  //MAGENTA  //蓝-冷却挤出头(PC7)
  #define HEATER_BED_PIN                     144
#endif


#define CONTROLLER_FAN_PIN                 140
